...
export const editableRootStyle = {
  '--slot4-page-bg': '#f7f7ff',
  '--slot4-page-text': '#171829',
  '--slot4-panel-bg': '#efefff',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#5f6378',
  '--slot4-soft-muted-text': '#85899d',
  '--slot4-accent': '#ff5a5a',
  '--slot4-accent-fill': '#ff5a5a',
  '--slot4-accent-soft': '#ffe5df',
  '--slot4-dark-bg': '#3100d8',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#eeeffb',
  '--slot4-cream': '#fff8ed',
  '--slot4-warm': '#fff3df',
  '--slot4-lavender': '#3b00f5',
  '--slot4-gray': '#f1f2f8',
  '--slot4-body-gradient': 'linear-gradient(180deg, #ffffff 0%, #f7f7ff 60%, #efefff 100%)',
} as CSSProperties
